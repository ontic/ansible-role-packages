# Ontic Packages ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-packages/master.svg)](https://travis-ci.org/ontic/ansible-role-packages) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.packages-blue.svg)](https://galaxy.ansible.com/ontic/packages/) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-packages.svg)](https://github.com/ontic/ansible-role-packages/releases) |

## Introduction

This role installs packages on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.packages
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-packages.git
  version: master
  name: ontic.packages
```
